...
model_directory = r'D:\UAJY\UAJY sem 5\ML\ML 1\Tugas_A_11948'
...
if os.path.exists(model_path):
    try:
        ...
        bloodPressure = st.slider("Blood Pressure (nmHg)", min_value=0,max_value=122,step=2)
    ...
    print("File 'rf_diabetes_model.pkl' tidak ditemukan di ditektori")
